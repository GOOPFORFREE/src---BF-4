...
game.CoreGui:FindFirstChild("Dr.xxx#9999 Ui").Enabled = not game.CoreGui:FindFirstChild("Dr.xxx#9999 Ui").Enabled
end)
...
do local GUI = game.CoreGui:FindFirstChild("Dr.xxx#9999 Ui");if GUI then GUI:Destroy();end;if _G.Color == nil then
...
function Update:Window(text,logo,keybind)
	...
	Main:TweenSize(UDim2.new(0, 656, 0, 390),"Out","Quad",0.4,true)
	...
	BindButton.Text = "Dr.xxx#9999 "
	BindButton.TextColor3 = Color3.fromRGB(0, 255, 255)
	BindButton.TextSize = 17.00
...
Main3:Button("thank you for play script ",function()
    
end)

Main3:Button("by ui and all GOOP HUB",function()
...
Main3:Toggle("AutoFarm Level",_G.AutoFarm,function(value)
        _G.AutoFarm = value
        _G.Seet = value
        _G.M = value
                    ...
                    elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                        ...
                        if game:GetService("Workspace").Enemies:FindFirstChild(Mon) then
                            ...
                            if game:GetService("ReplicatedStorage"):FindFirstChild(Mon) then
                                TP1(game:GetService("ReplicatedStorage"):FindFirstChild(Mon).HumanoidRootPart.CFrame * CFrame.new(0,0,30))
                            else
    ...
    Main3:Toggle("Auto Dought Boss",_G.AutoDoughtBoss,function(value)
...
spawn(function()
    ...
    Settings:Toggle("SuperVeryFast Attack",nil,function(value)
